...
?>
	<div class="container">
		<form method="post" action="multicast.php">

			<div class="input-group mb-3 input-group-sm">

				<select multiple class="form-control" name="userid[]" multiple required>
					<?php
                    $sql = "SELECT * FROM contact c left join field f on c.followfield = f.fieldid ";
					...
					<option value="<?php echo $row[ "userid" ]; ?>" >
						<?php echo $row[ "name"  ] . " " . $row["fieldname"] ; ?> </option>
...
<div class="float-left">
	<img src="http://qr-official.line.me/L/iNXSkSiSxz.png" class="img-fluid" style="height:200px;width:200px;">
	<a href="https://line.me/R/ti/p/%40wtb7501d"><img height="36" border="0" alt="เพิ่มเพื่อน" src="https://scdn.line-apps.com/n/line_add_friends/btn/en.png"></a>
	</div>
